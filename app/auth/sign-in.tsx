...
export default function SignInScreen() {
  ...
  return (
    <Screen>
      ...
      <Text style={styles.subtitle}>Jatka Bidalyx-työtilaan ja hallitse tarjouksia.</Text>
      ...
      <TextField label="Salasana" value={password} onChangeText={setPassword} secureTextEntry placeholder="Salasana" />
      <Button title={loading ? 'Kirjaudutaan...' : 'Kirjaudu sisään'} icon="log-in-outline" onPress={submit} disabled={loading || !email || !password} />
      <Pressable onPress={() => router.push('/auth/sign-up')}><Text style={styles.link}>Ei tiliä? Luo tili</Text></Pressable>
    </Screen>
  );
}

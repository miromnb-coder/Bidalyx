...
const styles = StyleSheet.create({
  ...
  aiBadge: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: spacing.sm, paddingVertical: 6, borderRadius: radii.full, backgroundColor: colors.blueSoft },
  ...
  summarySub: { marginTop: 2, fontSize: typography.small, color: colors.subtleText, fontWeight: '700' },
  serviceBadge: { paddingHorizontal: spacing.sm, paddingVertical: 7, borderRadius: radii.full, backgroundColor: colors.card },
  serviceText: { fontSize: typography.tiny, color: colors.text, fontWeight: '900' },
  ...
  infoCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  price: { fontSize: typography.h1, fontWeight: '900', color: colors.text },
  smallText: { fontSize: typography.small, color: colors.mutedText, fontWeight: '600' },
  roundIcon: { width: 48, height: 48, borderRadius: radii.full, backgroundColor: colors.blueSoft, alignItems: 'center', justifyContent: 'center' },
  checkRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginTop: spacing.xs },
  noteCard: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm, backgroundColor: colors.blueSoft },
  noteText: { flex: 1, fontSize: typography.small, lineHeight: 20, color: colors.text, fontWeight: '700' },

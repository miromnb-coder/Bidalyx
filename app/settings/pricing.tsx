...
export default function PricingSettingsScreen() {
  ...
  function save() {
    updatePricing({
      paintingPerSquareMeter: toNumber(painting, pricing.paintingPerSquareMeter),
      cleaningPerSquareMeter: toNumber(cleaning, pricing.cleaningPerSquareMeter),
      movingPerSquareMeter: toNumber(moving, pricing.movingPerSquareMeter),
      startFee: toNumber(startFee, pricing.startFee),
      travelFee: toNumber(travelFee, pricing.travelFee),
      vatPercent: toNumber(vat, pricing.vatPercent),
    });
    router.back();
  }
  ...
  return (
    <Screen>
      ...
      <TextField label="Maalaus €/m²" value={painting} onChangeText={setPainting} keyboardType="numeric" />
      <TextField label="Siivous €/m²" value={cleaning} onChangeText={setCleaning} keyboardType="numeric" />
      <TextField label="Muutto €/m²" value={moving} onChangeText={setMoving} keyboardType="numeric" />
      <TextField label="Aloitusmaksu €" value={startFee} onChangeText={setStartFee} keyboardType="numeric" />
      <TextField label="Matkakulu €" value={travelFee} onChangeText={setTravelFee} keyboardType="numeric" />
      <TextField label="ALV %" value={vat} onChangeText={setVat} keyboardType="numeric" />
